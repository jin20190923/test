<template>
   ...
   <tab-bar>
     <tab-bar-item path="/home" activeColor="#fb627c" >
     ...
     <tab-bar-item path="/category" activeColor="#fb627c">
     ...
     <tab-bar-item  path="/cart" activeColor="#fb627c">
     ...
     <tab-bar-item path="/profile" activeColor="#fb627c">
